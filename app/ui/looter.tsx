    ...
    return (
        <div className="flex flex-col gap-8 w-full">
            <div className="flex flex-col gap-4 justify-center max-w-screen-sm">
                ...
                <p className="text-sm font-medium text-caption leading-6">
                    Step into the arena armed with the <span className="highlight">ultimate launch toolkit</span>. Our <span className="highlight">battle-tested landing pages</span> are designed to <span className="highlight">maximize conversions</span> and pump your project to the moon. From <span className="highlight">captivating designs</span> to <span className="highlight">strategic UX</span>, we've got you covered.
                </p>
