    ...
    return (
        <div className="flex flex-wrap lg:flex-nowrap gap-4 items-center w-full justify-center">
            <div className="flex flex-wrap gap-4 w-full">
                ...
                <div className="flex flex-col w-80 overflow-hidden grow gap-6 px-8 py-6 rounded-3xl bg-background border border-transparentbg shadow-innerwhole">
                    <div className="flex items-baseline gap-2">
            ...
            <div className="flex flex-wrap gap-4 w-full">
                ...
                <Image priority quality={50} src={gradient} alt="" width={1080} height={1080} className="absolute lg:hidden -left-8 blur-xl h-[200%] bottom-0 w-[2rem]" />
                    <div className="flex items-baseline gap-2">
                        <h3>Dapp design</h3>
