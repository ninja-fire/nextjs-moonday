...
export default function ContactForm() {
    return(
        ...
        <form className="flex flex-col gap-6 px-4 md:px-8 py-6 bg-bodybg/[64%] backdrop-blur-md shadow-xl border border-transparentbg rounded-3xl" id="dynamic-form">
          <div className="flex pb-4 border-b border-transparentbg">
            <h4>Your Wish List</h4>
          </div>
          <div className="flex flex-col md:flex-row flex-start gap-6" id="form-content-needs">
            <div className="flex flex-col flex-start gap-6">
            <label className="flex gap-3 items-start" htmlFor="branding">
              <input className="w-4 h-4 rounded-xl" type="checkbox" id="branding" name="design-needs" value="branding" />
              <div className="flex flex-col gap-1">
                <h5 className="">Branding and Identity Design</h5>
                <p className="text-xs md:text-sm font-medium text-caption">Crafting unique visual identities that represent your brands values and
                  resonate with your target audience.</p>
              </div>
            </label>
            <label className="flex gap-3 items-start" htmlFor="print">
              <input type="checkbox" id="print" name="design-needs" value="print" />
              <div className="flex flex-col gap-1">
                <h5 className="">Print Design</h5>
                <p className="text-xs md:text-sm font-medium text-caption">Creating compelling designs for print materials such as brochures,
                  business cards, posters, and more.</p>
              </div>
            </label>
            <label className="flex gap-3 items-start" htmlFor="social">
              <input type="checkbox" id="social" name="design-needs" value="social" />
              <div className="flex flex-col gap-1">
                <h5 className="">Social Media Graphics</h5>
                <p className="text-xs md:text-sm font-medium text-caption">Crafting eye-catching graphics optimized for social media platforms to
                  boost your online presence.</p>
              </div>
            </label>
            <label className="flex gap-3 items-start" htmlFor="app">
              <input type="checkbox" id="app" name="design-needs" value="app" />
              <div className="flex flex-col gap-1">
                <h5 className="">Blockchain Application</h5>
                <p className="text-xs md:text-sm font-medium text-caption">Crafting user-friendly and visually appealing interfaces for blockchain
                  platforms, wallets, and decentralized applications.</p>
              </div>
            </label>
            </div>
            <div className="flex flex-col flex-start gap-6">
            <label className="flex gap-3 items-start" htmlFor="website">
              <input type="checkbox" id="website" name="design-needs" value="website" />
              <div className="flex flex-col gap-1">
                <h5 className="">Web3 Website Design</h5>
                <p className="text-xs md:text-sm font-medium text-caption">Designing immersive websites that seamlessly integrate blockchain
                  technology, providing interactive and engaging experiences.</p>
              </div>
            </label>
            <label className="flex gap-3 items-start" htmlFor="metaverse">
            ...
            <label className="flex gap-3 items-start" htmlFor="consulting">
              <input type="checkbox" id="consulting" name="design-needs" value="consulting" />
              <div className="flex flex-col gap-1">
                <h5 className="">Consultation and Ideation</h5>
                <p className="text-xs md:text-sm font-medium text-caption">Collaborating with you to brainstorm, conceptualize, and refine design
          ...
          <div className="gap-2 flex-start hidden" id="form-content-contact">
            <p className="text-xs md:text-sm font-medium text-caption">Please provide your name and email so we can reach out to you. It is the
