  ...
  return (
    <div className="flex gap-4 justify-center items-center w-full">
      <div className="flex flex-nowrap relative w-full rounded-full justify-center items-center h-80 overflow-hidden bg-background border border-transparentbg shadow-innerwhole">
        ...
        <Image src={looterlogo} width={2500} height={1562} alt="" className="flex absolute w-full rotate-[-30deg] scale-[320%] hover:scale-[324%] hover:brightness-[1.16] transition-all ease-in" />
      </div>
      <div className="flex relative w-full rounded-full justify-center items-center h-80 overflow-hidden bg-background border border-transparentbg shadow-innerwhole">
        <Image src={coinhouse} width={2500} height={1890} alt="" className="flex absolute center w-full scale-[400%] hover:scale-[404%] md:scale-[280%] md:hover:scale-[284%] hover:brightness-[1.16] transition-all ease-in" />
      </div>
      <div className="flex relative w-full rounded-full justify-center items-center h-80 overflow-hidden bg-background border border-transparentbg shadow-innerwhole">
        <Image src={family} width={1080} height={1080} alt="" className="flex absolute center w-full scale-[280%] hover:scale-[284%] hover:brightness-[1.16] transition-all ease-in" />
      </div>
      <div className="flex relative w-full rounded-full justify-center items-center h-80 overflow-hidden bg-background border border-transparentbg shadow-innerwhole hidden lg:flex">
        <Image src={trooper} width={2500} height={1794} alt="" className="flex absolute center w-full scale-[280%] hover:scale-[284%] hover:brightness-[1.16] transition-all ease-in" />
      </div>
      <div className="flex relative w-full rounded-full justify-center items-center h-80 overflow-hidden bg-background border border-transparentbg shadow-innerwhole hidden md:flex">
        <Image src={looter} width={2500} height={1801} alt="" className="flex absolute center w-full scale-[240%] hover:scale-[244%] hover:brightness-[1.16] transition-all ease-in" />
      </div>
      <div className="flex relative w-full rounded-full justify-center items-center h-80 overflow-hidden bg-background border border-transparentbg shadow-innerwhole hidden md:flex">
        <Image src={trooper2} alt="" className="flex absolute center w-full rotate-[-30deg] scale-[190%] hiver:scale-[194%] hover:brightness-[1.16] transition-all ease-in" />
      </div>
    </div>
  );
}