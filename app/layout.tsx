...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <div className="flex flex-col grow px-16 py-16 gap-40 overflow-hidden z-10 rounded-l-[32px] bg-bodybg border border-label/[.08] md:overflow-y-auto md:p-12">{children}</div>
      </main>
