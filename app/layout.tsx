...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <div className="noise flex flex-col grow px-4 md:px-16 2xl:px-40 pb-16 pt-40 gap-40 overflow-hidden z-10 rounded-l-[32px] bg-bodybg border border-label/[.08] md:overflow-y-auto">{children}</div>
      </main>
