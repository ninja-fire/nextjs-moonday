...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <div className="noise shadow-xl flex flex-col grow justify-center items-center px-4 md:px-16 2xl:px-40 pb-4 sm:pb-16 pt-40 gap-40 overflow-hidden z-10 rounded-l-[32px] bg-bodybg border border-label/[.08] md:overflow-y-auto">{children}</div>
      </main>
